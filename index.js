let subber = document.querySelector(".main-card");
let confirmation = document.querySelector(".confirmation");
let emailText = document.getElementById("email");
let confirm_btn = document.querySelector(".subscribe");
let dismiss_btn = document.querySelector(".dismiss");
let spanner = document.querySelector(".mailer");
let error_label = document.querySelector(".error-msg");
// This will be for the media query.
let imager = document.querySelector(".imager");


function isValid() {

    if (emailText.checkValidity()) {
        subber.style.display = "none";
        confirmation.style.display = "flex";
        spanner.textContent = emailText.value;

    } else {
        emailText.value = "";
        emailText.style.border = "1px solid var(--error)"; // Clear any inline styles
...
// This would be used to check if the screen is within this viewport width. Very important for future reference and need to add an SVG or similar
